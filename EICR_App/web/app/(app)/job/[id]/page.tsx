...
export default function JobOverviewPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl">
      <Card className={hasDangerousObservations ? "border-red-300 bg-red-50" : "border-green-300 bg-green-50"}>
      ...
      <Card>
        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-2 text-sm">
            ...
            <dt className="text-gray-500">Earthing</dt>
            <dd>{job.board_info?.earthing_arrangement || "-"}</dd>
            <dt className="text-gray-500">Ze</dt>
