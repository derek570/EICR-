...
2. **Execution order is now `Tier A → 08A → 08B → 06`**, with 02 demoted (see below) and
   ...
   ARM WINS, keep `recent_3`) and 08C-B (terminal-round lever — unblocked, `.ep-queue`-queued)**,
