...
export default function DefaultsPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl">
      ...
      <Card>
        <CardHeader><CardTitle className="text-base">Current Defaults</CardTitle></CardHeader>
        <CardContent>
          {defaultCount === 0 ? (
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-500">
            Apply your saved defaults to the {job.circuits.length} circuit{job.circuits.length !== 1 ? "s" : ""} in this job.
          </p>
          <div className="flex gap-3">
            <Button onClick={applyDefaultsToEmpty} disabled={applying || defaultCount === 0}>
              {applying ? (
                ...
                <><Check className="h-4 w-4 mr-2" />Apply to Empty Fields</>
              )}
            </Button>
            <Button onClick={applyDefaultsToAll} disabled={applying || defaultCount === 0} variant="outline">
