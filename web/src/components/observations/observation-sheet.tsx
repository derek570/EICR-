...
export function ObservationSheet({
  ...
  // Esc-to-cancel. Also locks body scroll while open.
  React.useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div
        className="relative z-10 flex w-full max-h-[92vh] flex-col overflow-hidden rounded-t-[var(--radius-xl)] bg-[var(--color-surface-0)] shadow-2xl md:w-[640px] md:max-w-[95vw] md:rounded-[var(--radius-xl)]"
