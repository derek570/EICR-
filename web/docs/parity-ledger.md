...
| `DashboardView.swift:L708-L724` `createAndNavigate` with auto-apply-defaults + preset picker sheet | `dashboard/page.tsx` simple create → push | partial | 6 | Phase 3 decision: skipped — preset picker depends on the Defaults system (Phase 6). Keep simple create until Defaults ships. |
