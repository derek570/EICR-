...
- **Active:** `SONNET_EXTRACT_MODEL=gpt-6-luna` (since 2026-09-22; `gpt-5.6-luna` before), `OPENAI_EXTRACT_SERVICE_TIER=fast`, and `OPENAI_EXTRACT_PROMPT_CACHE=explicit` in `ecs/task-def-backend.json`.
