...
| Date | Summary |
|------|---------|
| 2026-08-14 | **PLAN-G — P4 decline acks bypass the confirmations-OFF toggle (id 114; backend + web; iOS deferred).** Full detail: [changelog.md](docs/reference/changelog.md). |
