...
// /api/test/harness-mint-jwt — REMOVED in cleanup commit 2026-05-23.
// Lived briefly to unblock the Stage 0.G transcript-replay harness run
// when the only Mac with AWS credentials couldn't reach the VPC RDS
// instance to look up a userId. Mint flow + run results captured in
