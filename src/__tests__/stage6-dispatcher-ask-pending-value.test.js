...
describe('§A4 — regressions: flows that must NOT engage', () => {
  ...
  // Plan E, Codex r3 lens 3 — DISPOSITION PIN (reported as a wrong-write, found
  // NOT to be one; this test is what keeps it that way).
  //
  ...
  // the utterance goes to the model, where plan E's §4 precedence ladder routes
  // ohms-on-main-earth to Ze. The finding's repro reached the writer only by
  // hand-building a registry entry and calling past this gate.
  //
