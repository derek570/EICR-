...
const slots = [
  ...
  },
  {
    ...
    namedExtractor:
      /\b(\d{1,4})\s*(?:amps?|A)\b|\brating\b\s*(?:(?:(?:is|was|reads?|equals?|of)\b|['’]s)\s*)?(?:[:=]\s*)?(?:an?\s+)?(lim|limb|limp|limitation)\b/i,
    acceptsBareValue: true,
  },
  {
    ...
    // phrase (see ocpd.js).
    namedExtractor:
      /\b(\d+(?:\.\d+)?)\s*kA\b|\b(?:breaking\s+capacity|kilo\s*amps?|kA)\b\s*(?:(?:(?:is|was|reads?|equals?|of)\b|['’]s)\s*)?(?:[:=]\s*)?(?:an?\s+)?(lim|limb|limp|limitation)\b/i,
    acceptsBareValue: true,
  },
  {
    field: 'rcd_type',
  ...
  },
  {
    ...
    namedExtractor:
      /\b(\d{1,4})\s*(?:mA|milli\s*amps?)\b|\b(?:operating\s+current|milli\s*amps?|mA)\b\s*(?:(?:(?:is|was|reads?|equals?|of)\b|['’]s)\s*)?(?:[:=]\s*)?(?:an?\s+)?(lim|limb|limp|limitation)\b/i,
    acceptsBareValue: true,
  },
];
