...
Supply: earthing_arrangement, live_conductors, nominal_voltage_u, nominal_frequency, prospective_fault_current, earth_loop_impedance_ze, spd_bs_en, spd_type_supply, spd_rated_current, surge_spd_present, surge_spd_type, surge_spd_bs_en, surge_status_indicator, bonding_conductor_csa, earthing_conductor_csa, main_switch_conductor_csa
(spd_* = DNO supply cutout / main fuse; surge_* = a separate Surge Protection Device, BS EN 61643-11. "main fuse"/"cutout" → spd_*; "surge protection"/"Type N surge" → surge_*.)
