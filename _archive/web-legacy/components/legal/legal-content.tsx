...
export function LegalContent({ title, lastUpdated, children }: LegalContentProps) {
  return (
    <article className="prose prose-invert max-w-none prose-headings:scroll-mt-20">
      ...
      <div className="[&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-white [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:border-b [&_h2]:border-white/10 [&_h2]:pb-2 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-gray-200 [&_h3]:mt-6 [&_h3]:mb-3 [&_p]:text-gray-400 [&_p]:leading-relaxed [&_p]:mb-4 [&_strong]:text-white [&_table]:text-sm [&_th]:text-left [&_th]:p-3 [&_th]:bg-white/5 [&_td]:p-3 [&_td]:border-t [&_td]:border-white/5">
        {children}
      </div>
    </article>
  );
