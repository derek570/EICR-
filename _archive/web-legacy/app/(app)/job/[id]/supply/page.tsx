...
export default function SupplyPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <ButtonGroup
                ...
                onChange={(v) => updateField('supply_polarity_confirmed', v)}
              />
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Means of Earthing</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      {/* Earth Electrode — iOS-parity: shown conditionally when electrode is means of earthing */}
      {supply.means_earthing_electrode && (
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Earth Electrode</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-1.5">
                <Label htmlFor="electrode_type">Electrode Type</Label>
                <select
                  id="electrode_type"
                  value={supply.electrode_type || ''}
                  onChange={(e) => updateField('electrode_type', e.target.value)}
                  className="w-full h-10 rounded-md border border-gray-300 px-3 bg-white text-sm"
                >
              ...
              <div className="space-y-1.5">
                <Label htmlFor="electrode_resistance">Electrode Resistance (Ω)</Label>
                <Input
                  id="electrode_resistance"
                  value={supply.electrode_resistance || ''}
                  onChange={(e) => updateField('electrode_resistance', e.target.value)}
                  placeholder="e.g., 200"
                />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="electrode_location">Electrode Location</Label>
                <Input
                  id="electrode_location"
                  value={supply.electrode_location || ''}
                  onChange={(e) => updateField('electrode_location', e.target.value)}
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="space-y-2">
              <Dropdown
                ...
                field="rcd_operating_current"
                options={RCD_OPERATING_CURRENT}
                value={supply.rcd_operating_current}
                onChange={updateField}
              />
              <Input
                value={supply.rcd_operating_current_test || ''}
                onChange={(e) => updateField('rcd_operating_current_test', e.target.value)}
            ...
            <div className="space-y-2">
              <Dropdown
                id="rcd_td"
                label="Time Delay"
                field="rcd_time_delay"
                options={['Select...', '0', 'S', 'N/A', 'LIM']}
                value={supply.rcd_time_delay}
                onChange={updateField}
              />
              <Input
                value={supply.rcd_time_delay_test || ''}
                onChange={(e) => updateField('rcd_time_delay_test', e.target.value)}
                placeholder="Test result (ms)"
              />
            </div>
            <div className="space-y-2">
              <Dropdown
                ...
                field="rcd_operating_time"
                options={['Select...', 'N/A', 'LIM']}
                value={supply.rcd_operating_time}
                onChange={updateField}
              />
              <Input
                value={supply.rcd_operating_time_test || ''}
                onChange={(e) => updateField('rcd_operating_time_test', e.target.value)}
                placeholder="Test result (ms)"
              />
            </div>
          </div>
        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <ButtonGroup
                options={['PASS', 'FAIL', 'LIM', 'N/A']}
                value={supply.earthing_conductor_continuity}
                onChange={(v) => updateField('earthing_conductor_continuity', v)}
              />
            </div>
          </div>
        </CardContent>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <ButtonGroup
                ...
                onChange={(v) => updateField('bonding_conductor_continuity', v)}
              />
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-5 gap-4">
            {(
              ...
              <div key={field} className="space-y-1.5">
                <Label className="text-center block capitalize">
                  {field.replace('bonding_', '').replace('_', ' ')}
                </Label>
                <ButtonGroup
                  options={['PASS', 'FAIL', 'LIM', 'N/A']}
                  value={supply[field] as string}
          ...
          <div className="border-t pt-4">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.checked) updateField('bonding_other', '');
                  }}
                  className="h-4 w-4 rounded border-gray-300"
                />
            ...
            <Input
              ...
              disabled={supply.bonding_other_na || false}
              className={supply.bonding_other_na ? 'bg-gray-100' : ''}
            />
          </div>
        </CardContent>
      </Card>
