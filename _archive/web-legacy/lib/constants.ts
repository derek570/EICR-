 ...
 * Ported from frontend/src/lib/constants.ts
 */
...
// Observation codes
export const OBSERVATION_CODES = ["C1", "C2", "C3", "FI"] as const;
...
export const OBSERVATION_CODE_LABELS: Record<string, { label: string; color: string }> = {
  C1: { label: "Danger present", color: "red" },
  C2: { label: "Potentially dangerous", color: "orange" },
  C3: { label: "Improvement recommended", color: "blue" },
  FI: { label: "Further investigation", color: "gray" },
};

// Installation types for EIC
export const INSTALLATION_TYPES = ["new_installation", "addition", "alteration"] as const;
...
// Simple EICR schedule items (for linking observations)
export const SCHEDULE_ITEMS: Record<string, string> = {
...
export const EICR_SCHEDULE_SECTIONS: Record<string, Record<string, string>> = {
  ...
  "4. Consumer unit(s) / distribution board(s)": {
    ...
    "4.20": "Confirmation that ALL conductor connections are secure",
    "4.21":
      "Adequate arrangements where generating set operates as switched alternative",
...
export const SPD_BS_EN_OPTIONS = [
  "Select...",
  "LIM",
  "UNKNOWN",
  "88",
...
export const SHORT_CIRCUIT_CAPACITY = [
  "Select...",
  "1",
  "3",
  "6",
...
export const SPD_RATED_CURRENT = [
  "Select...",
  "60",
  "80",
  "100",
...
export const MAIN_SWITCH_BS_EN = [
  "Select...",
  "60947-3",
  "61008 RCD",
  "60947-2 MCCB",
...
export const MAIN_SWITCH_CURRENT = [
  "Select...",
  "40",
  "63",
  "80",
...
export const RCD_OPERATING_CURRENT = [
  "Select...",
  "10",
  "30",
  "100",
