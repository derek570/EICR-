...
export default function EICInspectionPage() {
  ...
  if (certificateType !== "EIC") {
    return (
      <div className="p-4">
        <p className="text-muted-foreground">This page is for EIC certificates. Use the EICR Inspection tab for EICR certificates.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <Card>
        <CardHeader><CardTitle className="text-base">Inspection Items</CardTitle></CardHeader>
        <CardContent>
