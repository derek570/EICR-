      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div
          className={`rounded-xl border-2 p-6 ${
            !isPro ? "border-primary bg-primary/5" : "border-slate-200 bg-white"
          }`}
        >
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mb-6">Everything you need for your business.</p>
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-green-500" />
      ...
      <div className="bg-white rounded-xl border p-6 space-y-4">
        {!billing?.billing_configured ? (
          <div className="text-center text-muted-foreground py-4">
            ...
            <p className="text-sm">Stripe integration is not active on this server. Contact support for help.</p>
          </div>
        ) : isPro ? (
          <>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 border rounded-lg hover:bg-slate-50 transition-colors disabled:opacity-50"
            >
              {actionLoading ? (
