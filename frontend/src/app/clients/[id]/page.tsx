...
import { api, User, ClientDetail, CreatePropertyData, PropertyWithJobs } from '@/lib/api';
      ...
      <header className="bg-card border-b border-border sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/clients">
              <Button variant="ghost" size="sm" aria-label="Back to clients">
                <ArrowLeft className="h-4 w-4" />
              </Button>
            </Link>
            <div>
              <h1 className="font-semibold truncate max-w-[200px] sm:max-w-none">{client.name}</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewProperty((p) => ({ ...p, property_type: e.target.value }))
                      }
